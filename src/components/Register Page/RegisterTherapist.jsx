...
//         try {
//             const response = await axios.post('https://proj.ruppin.ac.il/cgroup100/prod/api/SignInUser/SignUpTherapist', {
//                 FirstName: firstName,
//                 LastName: lastName,
//                 BirthDate: birthDate,
//                 Email: email,
...
//                     />
//                     <TextBox
//                         id={textBoxesArray[7].id}
//                         title={textBoxesArray[7].title}
//                         placeHolder={textBoxesArray[7].placeHolder}
//                         type={textBoxesArray[7].type}
//                         autoComplete={textBoxesArray[7].autoComplete}
//                         value={yearsexperience}
//                         onChange={handleYearsExp}
//                     />
//                      <SelectBox
